...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `berycoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ berycoincore-node add wallet-service');
      console.log('    $ berycoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ berycoincore-node remove wallet-service');
      console.log('    $ berycoincore-node remove insight-api');
      console.log();
    });
